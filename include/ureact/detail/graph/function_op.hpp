...
struct attach_functor
{
    ...
    {
        _get_internals( my_node.get_context() ).get_graph().on_node_attach( my_node, *dep_ptr );
    }
...
struct detach_functor
{
    ...
    {
        _get_internals( my_node.get_context() ).get_graph().on_node_detach( my_node, *dep_ptr );
    }
